...
// ---------------------------------------------------------------------------
async function detectDomainTechStack(domainPath) {
    const techStack = [];
...
// ---------------------------------------------------------------------------
function generateDescription(name, techStack, type) {
    if (techStack.includes('nestjs'))
...
// Monorepo detection
// ---------------------------------------------------------------------------
async function detectMonorepoDomains(projectDir) {
    const domains = [];
...
// ---------------------------------------------------------------------------
async function getWorkspacePatterns(projectDir) {
    const patterns = [];
...
// ---------------------------------------------------------------------------
async function detectSingleAppDomains(projectDir) {
    const domains = [];
...
// Main
// ---------------------------------------------------------------------------
export async function detectDomains(projectDir) {
